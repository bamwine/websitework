...
//getting the additional info values
                ...
                //checking if the image exists
                    ...
                    if ($post_category == "--Choose category--") {
                        ...
                        $db->enter_pod($post_title, $post_content, $post_image, $new_cat, $page, $status, $author, $tags, $fieldname ,$fieldvalue);
                        $db->enter_cat($new_cat);

                    } else {

                        /*Entering the values into the db*/
                        $db->enter_pod($post_title, $post_content, $post_image, $post_category,  $page, $status, $author, $tags, $new_tag, $fieldname ,$fieldvalue);
            ...
            <form action="Podcast.php" method="post" enctype="multipart/form-data">
                <h2>Title</h2>
...
-->
        ...
        <!--/-End of col-md-->
            ...
            <div class="panel panel-default sharp-corners">
                <div class="panel-heading">
                    <h3 class="panel-title" style="font-weight:bold;">UPLOAD AN Audio</h3>
                </div>
                ...
                <div class="panel-body" style="overflow: hidden;">
                    ...
                    <div>
                        <p id="profile_pic" style="width:100%;">Upload Audio</p>
                    </div>
                    <!--/--Checkbox-->
