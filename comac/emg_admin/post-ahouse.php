...
(housesTitle,housesOverview,Price,location,bedrooms,bathrooms,parking,mat_type,kitchen,status,house_type,Vimage1,Vimage2,Vimage3,Vimage4,Vimage5) 
VALUES(:HouseTitle,:Houseorcview,:priceperday,:Location,:Bedrooms,:Bathrooms,:Parking,:mat_type,:kitchen,:house_status,:house_type,:vimage1,:vimage2,:vimage3,:vimage4,:vimage5)";
...
<head>
	...
	<title>Admin | Admin Post House</title>
...
<input type="hidden" name="mat_type" class="form-control" value="H" required>
...
<div class="col-sm-4">
<select class="selectpicker" name="Parking" required>
