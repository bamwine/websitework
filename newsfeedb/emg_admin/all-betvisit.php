...
<table class="table-responsive table-striped" style="width:100%; border-left:1px solid #CCCCCC; height:;">
    ...
    <?php
	$kk=date('y-m-d');
    $query = "SELECT count(*) as work FROM `emg_visit` WHERE `post_ID` = 'homebet' and  date(dater) = '$kk' ORDER BY id DESC";
...
<table class="table-responsive table-striped" style="width:100%; border-left:1px solid #CCCCCC; height:;">
    ...
    <?php
    $query = "SELECT count(*) as work FROM `emg_visit` WHERE `post_ID` = 'homebet'";
