...
<div id="page-content-wrapper">
    ...
    if(isset($_POST['submit'])){
        ...
        $db->add_info($id, $size, $price, $negotiate, $location);
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" name="location" id="location" class="form-control sharp-corners">
        </div>

        <div class="form-group">
            <label for="size">Size Of Land</label>
            <input type="text" name="size" id="size" class="form-control sharp-corners">
        </div>

        <div class="form-group">
            <label for="price">Price</label>
            <input type="text" name="price" id="price" class="form-control sharp-corners">
        </div>

        <div class="form-group">
            <label for="negotiate">Negotiable</label>
            <select name="negotiate" id="negotiable" class="form-control sharp-corners">
                <option>YES</option>
                <option>NO</option>
            </select>
        </div>
