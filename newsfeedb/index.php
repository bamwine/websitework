          ...
          <div class="single_post_content">
			...
			<div class=" tab-content tab-content-t ">
					...
					Your browser does not support the audio element.
							...
							<li>
							<figure class="bsbig_fig"> <a href="single_page.php?page=<?php echo $rows['id']; ?>" class="featured_img news" id="<?php echo $rows['id']; ?>"> <img height="200px;" src="<?php echo get_image_url($rows['post_image']); ?>"> <span class="overlay"></span> </a>
...
$total =$userRow['num'];	
  ...
  Your browser does not support the audio element.
									...
									<div class="mid-1">
										<div class="women">
											<h6><a href="single_page.php?page=<?php echo $rows['id']; ?>"  class="news" id="<?php echo $rows['id']; ?>">
